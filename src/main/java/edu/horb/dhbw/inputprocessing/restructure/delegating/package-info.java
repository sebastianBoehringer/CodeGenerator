 ...
 */
/**
 * Contains {@link edu.horb.dhbw.inputprocessing.restructure.IRestructurer}s for abstract types.
 * These usually call an appropriate method
 * {@link edu.horb.dhbw.util.LookupUtil} and delegate the work to an
 * {@link edu.horb.dhbw.inputprocessing.restructure.IRestructurer} for the appropriate class.
 */
