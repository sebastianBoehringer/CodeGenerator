 ...
 */
/**
 * Contains classes centered around the validation of
 * {@link edu.horb.dhbw.datacore.model.OOBase}.
 * Some validators are made more general. Thus users can use configuration on
 * a per programming basis and do not need to implement their own validators
 * for them.
 */
